...
public class ListModel extends LessAbstractListModel 
{
    ...
    public ListModel(CollectionItem collection, Object substance) {
        this.collection = collection;
        this.substance = substance;

        buildData();
        Utils.registerCollection(
            collection.getSubstance(substance),collection.getCollection(),this);
    }
