...
import org.objectweb.jac.aspects.gui.PointFormat;
import org.objectweb.jac.core.rtti.FieldItem;

/**
 * A Swing editor component for point values.
 */
public class PointEditor extends FormatEditor
    implements FieldEditor
{
    /**
     * Constructs a new Point editor. 
     */
    public PointEditor(Object substance, FieldItem field) {
        super(substance,field);
    }

    protected void initFormat(FieldItem field) {
        format = new PointFormat(field);
    }    
}
