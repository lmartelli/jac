 ...
 * @see Element
 * @version $Id: Composite.java,v 1.1 2004/03/23 13:59:49 laurent Exp $
 * @author Greg Wilkins
*/
public class Composite extends Element
{
     ...
     * @return This Composite (for chained commands)
     */
    public Composite add(int position, Object o)
    {
        if (nest!=null)
            nest.add(position,o);
        else
        {
            if (o!=null)
            {
                if (o instanceof Element)
                {
                    ...
                    elements.add(position,o);
                }
                else if (o instanceof String)
                    elements.add(position,o);
                else 
                    elements.add(position,o.toString());
            }
        }
        return this;
    }
