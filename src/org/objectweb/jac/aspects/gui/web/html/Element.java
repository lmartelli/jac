...
// $Id: Element.java,v 1.2 2004/04/30 01:16:55 laurent Exp $
// ---------------------------------------------------------------------------

// Laurent Martelli <laurent@aopsys.com> - 21 mar. 2004:
// Added appendAttribute() and addCssClass() mehods
 ...
 * Element.
 * @see org.mortbay.html.Page
 * @see org.mortbay.html.Composite
 * @version $Id: Element.java,v 1.2 2004/04/30 01:16:55 laurent Exp $
 * @author Greg Wilkins
*/
public abstract class Element
{
    ...
    public Element attribute(String attribute, Object value)
    {
        ...
        if (value!=null)
        {
            if (value instanceof String && ((String)value).indexOf('"')!=-1)
                value=quoteAttributeValue((String)value);
    ...
    public Element appendAttribute(String attribute, Object value) 
    {
        if (attributeMap==null)
            attributeMap=new Hashtable(10);
        ...
        if (value!=null)
        {
            if (value instanceof String && ((String)value).indexOf('"')!=-1)
                value=quoteAttributeValue((String)value);
            String currentValue = (String)attributeMap.get(attribute);
    ...
    /** add a css CLASS
     */
    public Element addCssClass(String c)
    {
        return appendAttribute(CLASS," "+c);
    }
