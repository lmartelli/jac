 ...
 */
public class SubstanceEvent extends Event {
    public SubstanceEvent(View source, 
                          Object substance) {
        super(source);
    ...
    public void setSubstance(Object newSubstance) {
        this.substance = newSubstance;
    }

    public String toString() {
        return "CollectionEvent{"+substance+"}";
    }
}
