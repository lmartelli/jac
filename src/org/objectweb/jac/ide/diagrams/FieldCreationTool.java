...
public class FieldCreationTool extends AbstractActionTool {

   public FieldCreationTool(DrawingEditor newDrawingEditor,
   ...
   public void action(Figure figure) {
      EventHandler.get().onInvoke(
         ...
         new InvokeEvent(
             ...
             .getMethod("addField(org.objectweb.jac.ide.Field)")));
   }
